    ...
    <div className='flex-shrink-0 h-full w-[300px] p-5 bg-green-400 rounded-xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between'>
        <div>
            <div className='flex justify-between items-center text-white'>
                <h3 className='bg-green-600/80 text-xs px-3 py-1 rounded shadow-sm font-semibold uppercase tracking-wider'>Medium</h3>
                <h4 className='text-sm font-medium'>22 Feb 2024</h4>
            </div>
            <h2 className='mt-5 text-2xl font-bold text-white tracking-tight leading-tight'>Design UI/UX</h2>
